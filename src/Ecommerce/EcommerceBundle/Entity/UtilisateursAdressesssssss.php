...
namespace Ecommerceeeeeeeeeee\EcommerceBundle\Entity;
...
class UtilisateursAdresses
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="UtilisateursBundle\Entity\Utilisateur", inversedBy="adresses")
     ...
     * Set utilisateur
     *
     * @param UtilisateursBundle\Entity\Utilisateur $utilisateur
     * @return UtilisateursAdresses
     */
    public function setUtilisateur(UtilisateursBundle\Entity\Utilisateur $utilisateur = null)
    {
     ...
     * Get utilisateur
     *
     * @return UtilisateursBundle\Entity\Utilisateur 
     */
