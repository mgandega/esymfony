 ...
 */
class Pages extends \PagesBundle\Entity\Pages implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PagesBundle\\Entity\\Pages' . "\0" . 'id', '' . "\0" . 'PagesBundle\\Entity\\Pages' . "\0" . 'titre', '' . "\0" . 'PagesBundle\\Entity\\Pages' . "\0" . 'deletedAt', '' . "\0" . 'PagesBundle\\Entity\\Pages' . "\0" . 'contenu', '' . "\0" . 'PagesBundle\\Entity\\Pages' . "\0" . 'slug'];
        }
